...
INSERT INTO media(id, url,shares) VALUES(?, ?, ?); /* Set up correctly the import options in Tools | Options! */ 

SELECT TOP 10 *  FROM media; /* Don't forget to "turn down" the import mode */
